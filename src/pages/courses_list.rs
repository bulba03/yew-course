...
use crate::{ api::{ self, ApiCourseInfoData }, components::course_card::CourseCard };
...
impl Component for CoursesList {
    type Message = Msg;
    type Properties = ();
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        let course_cards = self.courses.iter().map(|data| {
            html! { <CourseCard id={data.id as i128} description={data.short_desc.clone().unwrap()} difficulty=1 title={data.name.clone()} image_url={data.image.clone().unwrap()}/> }
        });
        html! {
        <div class="container is-fluid">
                    <div class="fixed-grid has-4-cols">
                        ...
                        // <CourseCard id = 0 title="C++ с нуля" description="Курс для базового ознакомления с одним из главных языков в программировании" difficulty=1 image_url="https://ip-calculator.ru/blog/wp-content/uploads/2021/02/6038586442907648.png"/>
                        // <CourseCard id = 1 title="Язык программирования Rust" description="Курс подойдет программистам любого уровня, которые хотят изучить новые возможности в программировании" difficulty=1 image_url="https://raw.githubusercontent.com/rust-lang/www.rust-lang.org/master/static/images/rust-social-wide-light.svg"/>
                        // <CourseCard id = 0 title="Лидерство в коллективе" description="Короткий курс с практическим обучением. Без воды и долгих речей. Только основные навыки." difficulty=1 image_url="https://static.tildacdn.com/tild3039-3134-4032-a637-663335343332/-7-.jpg"/>
                        // <CourseCard id = 1 title="Программирование на C#: от новичка до специалиста" description="Изучите C# и платформу .NET, включая .NET Core и начните практиковать объектно-ориентированное программирование (ООП)." difficulty=1 image_url="https://248006.selcdn.ru/main/iblock/9dd/9dd3c730431af9dbab7befd41814fcea/13eaa548ad580af37b96dfbd474da753.png"/>
                     </div>
                    </div>
        </div>
                }
